...
class SegmentationAccuracy(SegmentationMetric):
    ...
    def update(self, annotation, prediction):
        ...
        if self.profiler:
            self.profiler.update(annotation.identifier, self.name, result, prediction.mask)
        return result
...
class SegmentationIOU(SegmentationMetric):
    ...
    def update(self, annotation, prediction):
        ...
        if self.profiler:
            self.profiler.update(annotation.identifier, self.name, iou, prediction.mask)
...
class SegmentationMeanAccuracy(SegmentationMetric):
    ...
    def update(self, annotation, prediction):
        ...
        if self.profiler:
            self.profiler.update(annotation.identifier, self.name, acc_cls, prediction.mask)
        return acc_cls
